  ...
  <div class="editor-header">
    <div class="left">
      ...
      <Dropdown :trigger="['click']">
        ...
        <template #overlay>
          <Menu>
            <MenuItem @click="goLink('https://github.com/AndrewYGHUB/LineText/issues')">意见反馈</MenuItem>
            <MenuItem @click="goLink('https://github.com/AndrewYGHUB/LineText/blob/master/doc/Q&A.md')">常见问题</MenuItem>
    ...
    <div class="right">
      ...
      <a href="https://github.com/AndrewYGHUB/LineText" target="_blank">
